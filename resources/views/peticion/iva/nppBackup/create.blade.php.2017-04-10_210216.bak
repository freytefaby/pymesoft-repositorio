...
<div class="main-content">
				...
				{!!Form::open(array('url'=>'peticion/iva','method'=>'POST','autocomplete'=>'off','class'=>'form-horizontal','role'=>'form'))!!}
					{{Form::token()}}
				<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> % Iva </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Categor&iacute;a" required class="col-xs-10 col-sm-5" name="iva" />
										</div>
									</div>
