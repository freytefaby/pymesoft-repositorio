					...
					<div class="page-content">
						...
						<div class="row">
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
									<a href="clientes/create"><button class="btn btn-primary">
									...
									<br>
									<div class="col-md-6">
									{!! Form::open(array('url'=>'peticion/clientes','method'=>'GET', 'autocomplete'=>'off', 'role'=>'search'))!!}
												...
												<tr>
													...
													<td>
														<div class="hidden-sm hidden-xs btn-group">
															...
															<a href="{{URL::action('ClientesController@edit',$client->idcliente)}}"><button class="btn btn-xs btn-info" title="Editar">
														...
														<div class="hidden-md hidden-lg">
															<div class="inline pos-rel">
																...
																<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																	...
																	<li>
																		<a href="{{URL::action('CategoriaController@edit',$client->idcliente)}}" class="tooltip-success" data-rel="tooltip" title="Edit">
																			<span class="green">
