...
<div class="main-content">
			...
			{!! Form::open(array('url'=>'peticion/inventarioproductolaboratorio','method'=>'GET', 'autocomplete'=>'off', 'role'=>'search'))!!}
  ...
  <div class="form-group">
    <label for="inputPassword3">producto:</label>
      ...
      <input type="text" name="producto" class="form-control" id="inputPassword3" placeholder="Producto"  >
  ...
  <div class="col-md-3">
  <div class="form-group">
    <label for="inputPassword3">Codigo de barras</label>
     
	   <input type="text" name="codigobarra1" class="form-control"  placeholder="Codigo de barras " >
    ...
    <label for="inputPassword3">Proveedor</label>
     ...
     <select class="chosen-select form-control" name="proveedor" id="form-field-select-3" data-placeholder="Seleccione">
				...
				<table id="simple-table" class="table  table-bordered table-hover table-striped">
											...
											@foreach ($pro as $pro1)
											<tr>
											<td>{{$pro1->codigobarra1}}</td>
											<td>{{$pro1->descripcionproducto}}</td>
											<td>{{$pro1->descripcioncategoria}}</td>
											<td>{{$pro1->nombreproveedor}}</td>
											<td>{{$pro1->stock}}</td>
											<td>@if($pro1->idtipoproducto==2)
											...
											<td></td>
											<td></td>
											<td>T: {{$sumarray->numstock + $sumarray2->numstock}}</td>
											<td>T: {{number_format($sumarray->totalcosto + $sumarray2->totalcosto)}}</td>
											</tfoot>
								      </tbody>
										</table>
										{{$pro->appends(Request::only(['producto','codigobarra1','proveedor']))->render()}}
										</div>
										<div class="row">
										<div class="col-md-4">
										...
										<div class="col-md-12">
										@if(sizeof($pro)>0)
											{!! Form::open(array('url'=>'pdf/pdf_inventarioproductolaboratorio','method'=>'GET', 'target'=>'_blank', 'autocomplete'=>'off', 'role'=>'search'))!!}
										<button class="btn btn-app btn-light btn-xs" type="submit">
											<i class="ace-icon fa fa-print bigger-160"></i>
											Imprimir 
										</button>
										<input type="hidden" value="{{$productoq}}" name="producto">
										<input type="hidden" value="{{$codigobarraq}}" name="codigo">
										<input type="hidden" value="{{$proveedorq}}" name="proveedor">
											{!!Form::close()!!}
										@endif
										</div>
