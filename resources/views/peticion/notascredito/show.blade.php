									...
									<!-- RECOGIDA DE PRODUCTOS -->
										...
										<div class="col-xs-12 col-sm-4">
												...
												<div class="widget-body">
													<div class="widget-main">
														...
														<div>
															...
															<br />
															<h3><p class="text-muted">{{$nota->nombrecliente}}</p></h3>
														</div>

														<hr />
														<div>
															<label for="form-field-select-3">Descripcion:</label>

															<br />
															<h3><p class="text-muted">{{$nota->observaciones}}</p></h3>
														</div>
														<hr/>
														<div>
											...
											<div class="infobox-data">
												...
												<div class="infobox-content">Facturado</div>
											</div>
