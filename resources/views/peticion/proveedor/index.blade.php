					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								...
								Crud mantenimiento Proveedores.
								</small>
							</h1>
						...
						<div class="row">
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
									<a href="proveedores/create"><button class="btn btn-primary">
									...
									<br>
									<div class="col-md-6">
									{!! Form::open(array('url'=>'peticion/proveedores','method'=>'GET', 'autocomplete'=>'off', 'role'=>'search'))!!}
										...
										<table id="simple-table" class="table  table-bordered table-hover table-striped">
											...
											@foreach ($proveedor as $pro)
												...
												<tr>
													...
													<td class="center">
														<div class="action-buttons">
														{{$pro->nombrepropietarioproveedor}} {{$pro->apellidopropietarioproveedor}}
														</div>
													</td>
													<td class="center">
														<div class="action-buttons">
														{{$pro->celularproveedor}} 
														</div>
													</td>
													<td class="center">
														<div class="action-buttons">
													...
													<td>
														<div class="hidden-sm hidden-xs btn-group">
															...
															<a href="{{URL::action('ProveedoresController@edit',$pro->idproveedor)}}"><button class="btn btn-xs btn-info" title="Editar">
														...
														<div class="hidden-md hidden-lg">
															<div class="inline pos-rel">
																...
																<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																	...
																	<li>
																		<a href="{{URL::action('ProveedoresController@edit',$pro->idproveedor)}}" class="tooltip-success" data-rel="tooltip" title="Edit">
																			<span class="green">
