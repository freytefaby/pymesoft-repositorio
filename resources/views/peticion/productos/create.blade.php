...
<div class="main-content">
				...
				{!!Form::open(array('url'=>'peticion/productos','method'=>'POST','autocomplete'=>'off','role'=>'form'))!!}
					{{Form::token()}}
  ...
  <div class="form-group">
    ...
    @if(Session::get('producto')=="")
      <input type="text" name="producto" class="form-control" id="inputPassword3" placeholder="Producto" value="{{old('producto')}}">
    @else
  ...
  <div class="form-group">
    <label for="inputPassword3">Codigo de barras 1</label>
     @if(Session::get('codigobarra1')=="")
      <input type="text" name="codigobarra1" class="form-control" id="inputPassword3" placeholder="Codigo de barras 1" value="{{old('codigobarra1')}}">
   @else
  ...
  <div class="form-group">
    <label for="inputPassword3">Codigo de barras 2</label>
     @if(Session::get('codigobarra2')=="")
      <input type="text" name="codigobarra2" class="form-control" id="inputPassword3" placeholder="Codigo de barras 2" value="{{old('codigobarra2')}}">
     @else
  ...
  <div class="form-group">
    ...
    @if(Session::get('codigobarra3')=="")
      <input type="text" name="codigobarra3" class="form-control" id="inputPassword3" placeholder="Codigo de barras 3"  value="{{old('codigobarra3')}}">
   @else
  ...
  <div class="form-group">
    ...
    @if(Session::get('codigobarra4')=="")
      <input type="text" name="codigobarra4" class="form-control" id="inputPassword3" placeholder="Codigo de barras 4"  value="{{old('codigobarra4')}}">
    @else
  ...
  <div class="form-group">
    <label for="inputPassword3">Tipo producto</label>
      ...
      <select class="chosen-select form-control" name="tipoproducto" id="form-field-select-3" data-placeholder="Seleccione">
															    ...
															    @else
																@if(old('tipoproducto')==$tp->idtipoproducto)
																<option value="{{$tp->idtipoproducto}}" selected>{{$tp->descripciontipoproducto}}</option>
															    @else
  ...
  <div class="form-group">
   ...
   @if(Session::get('cantidadempaque')=="")
    <input type="number" name="cantidadempaque" class="form-control" id="inputPassword3" placeholder="Cantidad por caja" value="{{old('cantidadempaque')}}">
   @else
  ...
  <div class="form-group">
    ...
    @if(Session::get('stockminimo')=="")
      <input type="number" name="stockminimo" class="form-control" id="inputPassword3" placeholder="Minimo stock" value="{{old('stockminimo')}}">
    @else
  ...
  <div class="form-group">
    <label for="inputPassword3">Precio de compra</label>
      ...
      <input type="number" name="preciocompra" class="form-control" id="inputPassword3" placeholder="Precio compra" value="{{old('preciocompra')}}">
        @else
  ...
  <div class="form-group">
    <label for="inputPassword3">Precio venta</label>
      ...
      <input type="number" name="precioventa" class="form-control" id="inputPassword3" placeholder="Precio venta" value="{{old('precioventa')}}">
      @else
  ...
  <div class="form-group">
    <label for="inputPassword3">Precio sugerido</label>
     @if(Session::get('preciosugerido')=="")
      <input type="number" name="preciosugerido" class="form-control" id="inputPassword3" placeholder="Precio sugerido" value="{{old('preciosugerido')}}">
    @else
  ...
  <div class="form-group">
    ...
    @if(Session::get('stock')=="")
      <input type="number" name="stock" class="form-control" id="inputPassword3" placeholder="stock" value="{{old('stock')}}">
  @else
 ...
 <select class="chosen-select form-control" name="categoria" id="form-field-select-3" data-placeholder="Seleccione">
															    ...
															    @else
																@if(old('categoria')==$cat->idcategoria)
																<option value="{{$cat->idcategoria}}" selected>{{$cat->descripcioncategoria}}</option>
															    @else
  ...
  <div class="form-group">
    <label for="inputPassword3">Proveedor</label>
     ...
     <select class="chosen-select form-control" name="proveedor" id="form-field-select-3" data-placeholder="Seleccione">
															    ...
															    @else
															    @if(old('proveedor')==$p->idproveedor)
																<option value="{{$p->idproveedor}}" selected>{{$p->nombreproveedor}}</option>
															    @else
  ...
  <div class="form-group">
    <label for="inputPassword3">Comision</label>
     @if(Session::get('comision')=="")
      <input type="number" name="comision" class="form-control" id="inputPassword3" placeholder="Comision" value="{{old('comision')}}">
     @else
  ...
  <div class="form-group">
    ...
    @if(Session::get('estante')=="")
      <input type="number" name="estante" class="form-control" id="inputPassword3" placeholder="estanteria" value="{{old('estante')}}">
  @else
...
@if(Session::get('entrepano')=="")
      <input type="number" name="entrepano" class="form-control" id="inputPassword3" placeholder="entrepaño" value="{{old('entrepano')}}">
  @else
...
@if(Session::get('principio')=="")
      <input type="text" name="principio" class="form-control" id="inputPassword3" placeholder="Activo principio" value="{{old('principio')}}">
  @else
