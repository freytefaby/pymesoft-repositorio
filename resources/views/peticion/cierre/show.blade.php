...
<div class="main-content">
        ...
        @endif
														...
														<input class="form-control date-picker" disabled required name="fecha" id="id-date-picker-1" type="text" data-date-format="yyyy-mm-dd" value="{{$query}}" />
											...
											<div class="widget-box">
												...
												<div class="widget-body">
													<div class="widget-main">
														...
														<th><i class="fa fa-users" aria-hidden="true"></i> Ventas</th>
												...
												<div class="infobox-content">Otros ingresos <br> {{number_format($sumaingreso->ingreso)}}</div>
														...
														<div>
															...
															<div class="input-group">
																...
																<input class="form-control" value="{{number_format($exist->recogida)}}" type="text" disabled min="1" required name="recogida" value="{{old('valor')}}"/>
