					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								...
								Crud mantenimiento Cierres contables.
								</small>
							</h1>
						...
						<div class="row">
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
									{!!Form::open(array('url'=>'peticion/cierrediario','method'=>'POST','autocomplete'=>'off','class'=>'form-horizontal','role'=>'form'))!!}
													{{Form::token()}}
													<input type="hidden" name="usuario" value="{{Session::get('id')}}">
													@if(count($ultimocierre)=="")
													...
													@else
													<input type="hidden" name="ultimocierre" value="{{$ultimocierre->estado}}">
												   @endif
													@endif
                                          ...
                                          <tbody>
											...
											@foreach ($cierre as $c)
												...
												<tr>
													...
													<td>HHCD-00{{$c->idusuario}}{{$c->idcierrediario}}</td>
													<td>{{number_format($c->valorventa)}}</td>
												...
												<td>
														...
														<div class="hidden-sm hidden-xs btn-group">
															...
															<a href="{{URL('peticion/cierrediario/create?fecha='.$date->format('Y-m-d'))}}"><button class="btn btn-xs btn-success" title="Seguir modificando">
																<i class="ace-icon fa fa-pencil bigger-120"></i>
															</button></a>
															@else
																<a href="{{URL::action('CierreController@show',$c->idcierrediario)}}" target="_blank"><button class="btn btn-xs btn-info" title="Ver factura">
																<i class="ace-icon fa fa-eye bigger-120"></i>
										
															</button></a>
															

															<a href="{{URL('pdf/cierre/print_cierre/'.$c->idcierrediario)}}" target="_blank" ><button class="btn btn-xs btn-warning" title="Informe pdf">
