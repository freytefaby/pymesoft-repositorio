					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								...
								Crud mantenimiento Categor&iacute;as.
								</small>
							</h1>
						...
						<div class="row">
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
									<a href="categoria/create"><button class="btn btn-primary">
												<i class="ace-icon glyphicon glyphicon-plus"></i>
												Crear nueva categor&iacute;a
											</button></a><br><br>
									<div class="table-responsive">
									<br>
									<div class="col-md-6">
									{!! Form::open(array('url'=>'peticion/categoria','method'=>'GET', 'autocomplete'=>'off', 'role'=>'search'))!!}
									...
									{{Form::close()}}
												...
												<tr>
													...
													<td>
														<div class="hidden-sm hidden-xs btn-group">
															...
															<a href="{{URL::action('CategoriaController@edit',$cat->idcategoria)}}"><button class="btn btn-xs btn-info" title="Editar">
																<i class="ace-icon fa fa-pencil bigger-120"></i>
															</button></a>

															<a href="" data-target="#modal-delete-{{$cat->idcategoria}}" data-toggle="modal" ><button class="btn btn-xs btn-danger" title="Eliminar">
														...
														<div class="hidden-md hidden-lg">
															<div class="inline pos-rel">
																...
																<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																	...
																	<li>
																		<a href="{{URL::action('CategoriaController@edit',$cat->idcategoria)}}" class="tooltip-success" data-rel="tooltip" title="Edit">
																			<span class="green">
                                        ...
                                        @include('peticion.categoria.modal')
												@endforeach
