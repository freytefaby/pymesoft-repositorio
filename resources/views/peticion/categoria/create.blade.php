...
<div class="main-content">
					...
					<div class="page-header">
							<h1>
								...
								<small>
									...
									Agregar una nueva categor&iacute;as
								</small>
							</h1>
						</div><!-- /.page-header -->
				...
				{!!Form::open(array('url'=>'peticion/categoria','method'=>'POST','autocomplete'=>'off','class'=>'form-horizontal','role'=>'form'))!!}
					{{Form::token()}}
				<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nueva Categor&iacute;a </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Categor&iacute;a" class="col-xs-10 col-sm-5" name="categoria" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1-1" placeholder="Agrega una descripci&oacute;n" class="col-xs-10 col-sm-5" name="descripcion" />
										</div>
									</div>
