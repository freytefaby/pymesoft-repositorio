						...
						<div class="row">
							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<td>Valor de convenio</td>
								    <td>Cupo maximo disponible</td>
									<td>Fecha Limite</td>
									<td>Establecer abonos</td>
									...
									<?php $cont=$cont+1; $sumcon=$sumcon + $con->ventas; $cupo=$cupo+$con->max_credito; ?>
									<tbody>
									
									<tr>
									<td>{{$con->nombrecliente}}</td>
									<td>{{number_format($con->ventas)}}</td>
									<td>{{number_format($con->max_credito)}}</td>
									<td><?php $a=fecha_credito($con->fecha,$con->dias_credito); echo fecha($a)?></td>
									<td>{!! Form::open(array('url'=>'peticion/convenio/create','method'=>'GET'))!!}
									<input type="hidden" name="id" value="{{$con->idcliente}}">
									<button type="submit" value="{{$con->idcliente}}" class="btn btn-primary">Abono</button>
									{{Form::close()}}
									</td>
									...
									<tr>
									<td>{{$cont}}</td>
									<td>{{number_format($sumcon)}}</td>
									<td>{{number_format($cupo)}}</td>
									<td></td>
									</tr>	
									</tfoot>
									</table>
