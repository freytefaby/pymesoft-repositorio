...
<head>
<title>
HHFDC-000{{$devoluciones->idcompra}}{{$devoluciones->iddevolucioncompra}}
</title>
<meta charset="utf-8" />
...
{{$infoempresa->nombrecomercialempresa}}<br>
	...
	===============================<br>
Devolucion: HHFDC-00{{$devoluciones->idcompra}}{{$devoluciones->iddevolucioncompra}}<br>
===============================<br>
</div>
...
Proveedor: {{$devoluciones->nombreproveedor}}<br>
Nit: {{$devoluciones->nitproveedor}}
