					...
					<div class="page-content">
						...
						<div class="row">
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
									<a href="ingreso/create"><button class="btn btn-primary">
									...
									<br>
									<div class="col-md-6">
									{!! Form::open(array('url'=>'peticion/ingreso','method'=>'GET', 'autocomplete'=>'off', 'role'=>'search'))!!}
									<div class="form-group">
									<div class="input-group">
									<input class="form-control date-picker" name="p" id="id-date-picker-1" type="text" data-date-format="yyyy-mm-dd" value="{{$searchText}}" />
										...
										<table id="simple-table" class="table  table-bordered table-hover table-striped">
											...
											@foreach ($ingreso as $g)
												...
												<tr>
													...
													<td class="center">
														<div class="action-buttons">
														{{number_format($g->valoringreso)}}
														</div>
													</td>
													<td class="center">
														<div class="action-buttons">
														{{number_format($g->utilidadingreso)}}
														</div>
													</td>
													<td class="center">
														<div class="action-buttons">
													...
													<td>
														<div class="hidden-sm hidden-xs btn-group">
															@if($g->estado==0)
													<a href="{{URL::action('IngresoController@edit',$g->idingreso)}}"><button class="btn btn-xs btn-info" title="Editar">
													...
													<a href="{{URL::action('IngresoController@edit',$g->idingreso)}}" class="tooltip-success" data-rel="tooltip" title="Edit">
																			<span class="green">
...
<!-- basic scripts -->
		...
		<!--[if !IE]> {{asset('public/js/jquery-ui.custom.min.js')}} -->
