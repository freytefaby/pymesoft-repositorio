...
<div class="main-content">
             ...
             @endif
			     ...
			     {!!Form::open(array('url'=>'peticion/updatecontrasena/'.$usuarios->idusuario,'class'=>'form-horizontal'))!!}
				 {{Form::token()}}
				<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<input type="password" id="form-field-1" placeholder="xxxxx" class="col-xs-10 col-sm-5" name="contrasena" />
										
										</div>
									</div>

									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Confirmar</label>

										<div class="col-sm-9">
										 
											<input type="password" id="form-field-1-1" placeholder="xxxxx" class="col-xs-10 col-sm-5" name="confirmar" />
