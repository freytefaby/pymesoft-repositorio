						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Panel principal y creación de nuevas compras
								</small>
							</h1>
						</div><!-- /.page-header -->
											...
											<div class="widget-box">
												...
												<div class="widget-body">
													<div class="widget-main">
														...
														@foreach($detallecompra as $comps )
														
														</tr>
														
														<td>{{$comps->codigobarra1}}</td>
														<td>{{$comps->descripcionproducto}}</td>
														<td>{{$comps->nombreproveedor}}</td>
														<td>{{$comps->cantidad}}</td>
														<td>{{number_format($comps->valorcompra)}}</td>
														<td>{{number_format($comps->subtotalcompra)}}</td>
											...
											<div class="widget-box">
												...
												<div class="widget-body">
													<div class="widget-main">
														...
														<div>
															<label for="form-field-select-3">Provedor:</label>
