...
<div class="main-content">
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Panel principal y creación de nueva compra
								</small>
							</h1>
						</div><!-- /.page-header -->
        ...
        @endif
							 @include('peticion.compras.modalsearchproductos')
											...
											<div class="widget-box">
												...
												<div class="widget-body">
													<div class="widget-main">
														...
														<td><a href="" data-target="#modal-delete-{{$pro->iddetallecompra}}" data-toggle="modal" ><button class="btn btn-xs btn-danger" title="Editar" >
																<i class="fa fa-trash" aria-hidden="true"></i> Quitar
															</button></a></td>
														</tr>
														 @include('peticion.compras.modal')
														@endforeach
														<tfoot>
									...
									{!!Form::model($ultimacompra,['method'=>'PATCH','route'=>['peticion.compras.update',$ultimacompra->idcompra],'class'=>'form-horizontal'])!!}
					               {{Form::token()}}
                                     ...
                                     @endif
								               ...
								               @endif
														<div>
															...
															<br />
															<select class="chosen-select form-control" name="proveedor" id="form-field-select-3" data-placeholder="Seleccione Cliente">
																<option value="1">  </option>
																@foreach($proveedores as $prove)
																@if(Session::get('proveedor')==$prove->idproveedor)
																	<option value="{{$prove->idproveedor}}" selected>{{$prove->nombreproveedor}} </option>
																@else
																	
																@if(old('proveedor')==$prove->idproveedor)
																<option value="{{$prove->idproveedor}}" selected>{{$prove->nombreproveedor}}</option>
															   @else
																<option value="{{$prove->idproveedor}}">{{$prove->nombreproveedor}}</option>
															   @endif
															   @endif
																@endforeach
															</select>
														...
														<div>
															...
															<div class="input-group">
															   ...
															   <input class="form-control" type="text"  name="factura" value="{{Session::get('factura')}}"/>
														   @else
																<input class="form-control" type="text"   name="factura" value="{{old('factura')}}"/>
															@endif
											...
											<div class="infobox-data">
												...
												<div class="infobox-content">Valor compra</div>
											</div>
                                            ...
                                            <button class="btn btn-xs btn-success" title="Facturar" type="submit">
																<i class="ace-icon fa fa-check bigger-110"></i> Autorizar compra
															</button>
															<!--IMPUTS-->
															<input type="hidden" name="valorcompra" value="{{$sumarray->val}}">
