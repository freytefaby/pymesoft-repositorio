...
<table id="dynamic-table" class="table table-striped table-bordered table-hover table-condensed">
                                          ...
                                          <tbody>
											...
											@foreach($medicamento as $med)
												...
												<tr>
													<TD class="hidden-xs hidden-sm"><a href="{{URL('peticion/compras/create?p='.$med->codigobarra1)}}">{{$med->descripcionproducto}} </a> </TD>
                                        ...
                                        <tr ><td class="hidden-md hidden-lg" ><a href="{{URL('peticion/compras/create?p='.$med->codigobarra1)}}">{{$med->descripcionproducto}} </a> <br> {{$med->nombreproveedor}} <br>  {{$med->codigobarra1}} <br> Stock {{$med->stock}} </td></tr>
												@endforeach
