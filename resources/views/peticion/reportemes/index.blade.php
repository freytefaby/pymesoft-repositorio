...
<div class="main-content">
										...
										<div class="col-xs-12 col-sm-8">
											<div class="widget-box">
												<div class="widget-header">
													<h4 class="widget-title">Rango de fecha</h4>
        ...
        @endif
													{!! Form::open(array('url'=>'peticion/reportemes/','method'=>'GET', 'autocomplete'=>'off', 'class'=>'form-inline'))!!}
													<div class="col-md-3">
											...
											<div class="widget-box">
												<div class="widget-header">
													<h4 class="widget-title">Detalle ventas generadas en el rango</h4>
                        ...
                        <i class="fa fa-exclamation-triangle" aria-hidden="true"></i> {{Session::get('mensaje2')}}
                                     ...
                                     @endif
										...
										<div>
											...
											<div class="infobox-data">
												<span class="infobox-data-number"></span>
												<div class="infobox-content">Compras <br> {{number_format($sumacompra->valcompra)}}</div>
											</div>
														...
														{!! Form::open(array('url'=>'pdf/pdf_reportemes','method'=>'GET', 'target'=>'_blank', 'autocomplete'=>'off', 'role'=>'search'))!!}
