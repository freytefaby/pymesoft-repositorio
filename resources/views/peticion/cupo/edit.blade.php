...
<div class="main-content">
					...
					<div class="page-header">
							<h1>
								...
								<small>
									...
									Estas editando cupo a: {{$cupo->nombrecliente}} {{$cupo->apellidocliente}}
								</small>
							</h1>
						</div><!-- /.page-header -->
				...
				{!!Form::model($cupo,['method'=>'PATCH','route'=>['peticion.cupo.update',$cupo->idconvenio],'class'=>'form-horizontal'])!!}
					{{Form::token()}}
				<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Maximo cupo de credito </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Valor de cupo" class="col-xs-10 col-sm-5" name="valor" value="{{$cupo->max_credito}}" />
										</div>
									</div>

									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Dias de credito </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1-1" placeholder="dias" class="col-xs-10 col-sm-5" name="dias" value="{{$cupo->dias_credito}}" />
										</div>
									</div>
