...
<div class="main-content">
				...
				{!!Form::model($base,['method'=>'PATCH','route'=>['peticion.base.update',$base->idbasecaja],'class'=>'form-horizontal'])!!}
					{{Form::token()}}
				<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nueva base </label>

										<div class="col-sm-9">
											<input type="number" id="form-field-1" required  placeholder="Categor&iacute;a" class="col-xs-10 col-sm-5" name="base" value="{{$base->valorbase}}" />
										</div>
									</div>
