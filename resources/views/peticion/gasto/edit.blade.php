...
<div class="main-content">
					...
					<div class="page-header">
							<h1>
								...
								<small>
									...
									Edita gasto {{$gasto->proveedorgasto}}
								</small>
							</h1>
						</div><!-- /.page-header -->
				...
				{!!Form::model($gasto,['method'=>'PATCH','route'=>['peticion.gasto.update',$gasto->idgasto],'class'=>'form-horizontal'])!!}
					{{Form::token()}}
				<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Descripción </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" value="{{$gasto->descripciongasto}}" class="col-xs-10 col-sm-5" name="descripcion" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1-1"  class="col-xs-10 col-sm-5" name="proveedor" value="{{$gasto->proveedorgasto}}" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="number" required id="form-field-1-1" value="{{$gasto->valorgasto}}" class="col-xs-10 col-sm-5" name="valor" />
										</div>
									</div>
