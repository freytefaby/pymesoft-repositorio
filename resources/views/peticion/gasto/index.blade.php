						...
						<div class="row">
							...
							<div class="col-xs-12">
								...
								<div class="row">
									...
									<br>
									<div class="col-md-6">
									{!! Form::open(array('url'=>'peticion/gasto','method'=>'GET', 'autocomplete'=>'off', 'role'=>'search'))!!}
									<div class="form-group">
									<div class="input-group">
									<input class="form-control date-picker" name="p" id="id-date-picker-1" type="text" data-date-format="yyyy-mm-dd"  />
												...
												<tr>
													...
													<td>
														<div class="hidden-sm hidden-xs btn-group">
															@if($g->estado==0)
													<a href="{{URL::action('GastoController@edit',$g->idgasto)}}"><button class="btn btn-xs btn-info" title="Editar">
													...
													<a href="{{URL::action('GastoController@edit',$g->idgasto)}}" class="tooltip-success" data-rel="tooltip" title="Edit">
																			<span class="green">
