...
<div class="main-content">
				...
				{!!Form::open(array('url'=>'peticion/perfil','method'=>'POST','autocomplete'=>'off','class'=>'form-horizontal','role'=>'form'))!!}
					{{Form::token()}}
				<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nombre de perfil </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Nuevo perfil" class="col-xs-10 col-sm-5" name="perfil" />
										</div>
									</div>
