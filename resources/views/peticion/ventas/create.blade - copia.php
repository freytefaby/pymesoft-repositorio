...
<div class="main-content">
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Panel principal y creación de facturas
								</small>
							</h1>
						</div><!-- /.page-header -->
            ...
            <div class="alert alert-warning" id="msj-error" style="display:none;">
                <button type="button" class="close" data-dismiss="alert">x</button>
               <i class="fa fa-exclamation-triangle" aria-hidden="true"></i> <strong id="mensaje" ></strong> 
            </div>
			 <div class="alert alert-success" id="msj-success" style="display:none;">
                <button type="button" class="close" data-dismiss="alert">x</button>
               <i class="ace-icon fa fa-check bigger-110" aria-hidden="true"></i> <strong id="mensaje" >Producto registrado</strong> 
            </div>
		
													<!--  {!! Form::open(array('url'=>'peticion/ventas/create/','method'=>'GET', 'autocomplete'=>'off', 'class'=>'form-inline'))!!}-->
													<div class="col-md-3">
														<input type="text" class="form-control" name="p" id="buscar"  value="<?php if(isset($_GET["p"])) { echo $_GET["p"]; } ?>"   placeholder="Seleccione producto"  autofocus>
														
														</div>
														

														
														<button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="ace-icon fa fa-check bigger-110"></i>Buscar</button>
														 @include('peticion.ventas.modalsearchproductos')
									...
									<!--{!!Form::model($ultimaventa,['method'=>'PATCH','route'=>['peticion.ventas.update',$ultimaventa->idventa],'class'=>'form-horizontal'])!!}
					               {{Form::token()}}-->
...
@section('scripts')
		...
		<script>
		function recarga(){
			$.get("{{URL('peticion/detalleproductos')}}",function(datos, status){
					
					
					$("#detalle").html(datos);
				});
				
				$.get("{{URL('peticion/ventajax')}}",function(datos, status){
